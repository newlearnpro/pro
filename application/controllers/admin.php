...
//			chmod('uploads', 0755);
//		  echo $this->upload_folder .'lesson_type_'.$get_info['lesson_type_id'].'/'. '0' . $get_info['lesson_type_id'] . $get_info['lesson_parent_id'] . '_'.$date.'';
//echo $this->upload_folder;
//echo  '0' . $get_info["lesson_type_id"] . $get_info["lesson_parent_id"] . '_'.$date;
//chmod('0' . $get_info["lesson_type_id"] . $get_info["lesson_parent_id"] . '_'.$date, 0777);
	    	   mkdir($this->upload_folder .'lesson_type_'.$get_info["lesson_type_id"].'/'. '0' . $get_info["lesson_type_id"] . $get_info["lesson_parent_id"] . '_'.$date, 0777, true);
//chmod('0' . $get_info["lesson_type_id"] . $get_info["lesson_parent_id"] . '_'.$date, 0777);

//echo 
//chmod()
		  // chmod($this->upload_folder .'lesson_type_'.$get_info['lesson_type_id'].'/'. '0' . $get_info['lesson_type_id'] . $get_info['lesson_parent_id'] . '_'.$date.'', 0755);
    	...
    	redirect(base_url().$this->uri->segment(1).'/admin/index/addlesson');
	}
