function GameWork() {
    ...
    this.bg_sound_all = function() {
        ...
        var bg_sound = "on";
        $("#bg_audio").remove();
        $("#part_laboratory").append('<audio id="bg_audio"><source src="assets/app/audio/bg.mp3" type="audio/mpeg"/></audio>');
    ...
    this.fnc_aud_append = function(id, audio_name, start_duration, func_on, func, puls1_el, puls1_start, puls1_dur, pils2_el, puls2_start, puls2_dur, puls3_el, puls3_start, puls3_dur, puls4_el, puls4_start, puls4_dur, puls5_el, puls5_start, puls5_dur, puls6_el, puls6_start, puls6_dur) {
        ...
        audioTimeout1 = setTimeout(function() {
            if (my_audio !== undefined) {
                my_audio.unload(); // audio unload,  bug fix
            }
            my_audio = new Howl({
                src: ['assets/app/audio/' + audio_name + '.mp3'],
                volume: 1,
                autoplay: true,
                onend: function() {
                    $(".off_all, #off_all_" + id).remove();
                    refresh_req();
                    if (id == "true_answer") {
                        $("#requirement_ref").css({
                            "display": "none"
            ...
            audioInterval1 = setInterval(function() {
                var currentTime = my_audio.seek();
